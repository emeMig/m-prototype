<template>
    <b-card no-body class="bg-default shadow">
        <b-card-header class="bg-transparent border-0">
            <h3 class="mb-0 text-white">Circutos corporativos</h3>
        </b-card-header>

        <el-table class="table-responsive table table-dark"
                  header-row-class-name="thead-dark"
                  :data="projects">
            <el-table-column label="Circuito"
                             min-width="310px"
                             prop="name">
                <template v-slot="{row}">
            ...
            <el-table-column label="Localización"
                             prop="budget"
                             min-width="140px">
            </el-table-column>

            <el-table-column label="Exclusivista Asignado"
                             min-width="170px"
                             prop="status">
                <template v-slot="{row}">
